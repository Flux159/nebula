...
// Hoisted into nebula-core (the vessels/API work shares it); re-exported so
// every `client::nebula_home()` caller keeps working.
pub use nebula_core::home::nebula_home;
